---
layout: post
title: "BitcoinSV #4 Transaction with multiple inputs"
---
이전 글 [BitcoinSV &#35;3 Broadcast raw transaction](/BitcoinSV-broadcast-transaction.html)에서는 input이 1개, output도 1개인 transaction을 만들어서 broadcast해보았다.
